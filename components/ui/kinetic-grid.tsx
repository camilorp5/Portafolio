...
const LINE_BASE = { r: 226, g: 232, b: 240, a: 0.6 }; // Slate-200 suave
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        light: {
          bg: "#ffffff",
          lineActive: { r: 37, g: 99, b: 235, a: 0.8 }, // Azul institucional brillante (Blue-600)
      ...
      // Puntos suaves estáticos en el fondo
      ...
      for (let row = 0; row < rows; row++) {
        for (let col = 0; col < cols; col++) {
          ...
          if (t > 0.3) {
            ...
            grd.addColorStop(0, `rgba(${theme.glow},${(t * 0.2).toFixed(3)})`);
